...
export default function Home() {
	...
	return (
		<div className="flex flex-col items-center justify-center min-h-screen text-white bg-primary-blue">
				...
				{!publicKey ? (
					...
					<>
						...
						<div className="relative mb-4">
							...
							/>
							<button className="absolute text-white transform -translate-y-1/2 right-4 top-1/2">
								<X size={20} />
							</button>
						</div>
